...
// Commenting it as of now since it is already covered in selenium - Vrushali
// We will use this code in future when we start migrating from selenium to playwright
